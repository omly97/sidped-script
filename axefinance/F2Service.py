...
class F2Service:
    ...
    def __init__(self) -> None:
        self.gsheet = GsheetService(GSHEET_FINANCE['F2']['spreadsheet_key'])
    ...
    # Get Gsheet data
    def get_data(self):
        return self.gsheet.get_data_from_worksheet(GSHEET_FINANCE['F2']['worksheet_id'])
    ...
    def get_data_calculated(self):
        ...
        calcul_score = lambda CP,CA,B: ((CP+CA)/B) * 100
