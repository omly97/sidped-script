...
class H2BService:
    ...
    def __init__(self) -> None:
        self.gsheet = GsheetService(GSHEET_HUMAN['H2B']['spreadsheet_key'])
    ...
    # Get Gsheet data
    def get_data(self):
        return self.gsheet.get_col_values_from_worksheet(GSHEET_HUMAN['H2B']['worksheet_id'], self.COLUMN_VALUES)
